...
import static com.notadeveloper.app.npa.ResultActivity.getmaxtotal;
import static com.notadeveloper.app.npa.ResultActivity.gettotal;
...
//            else mNext.setText("Next");
    ...
    private void getoptionsandscore(String x, ArrayList opt, ArrayList sco) {
        String a[] = x.split("[,;]");
        opt.clear();
        sco.clear();
    ...
    private void getoptionsandscorespinner(String x, ArrayList opt, ArrayList sco) {
        String a[] = x.split("[,;]");
        opt.clear();
        sco.clear();
