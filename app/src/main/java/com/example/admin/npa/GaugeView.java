    ...
    protected void onDraw(Canvas canvas){
        ...
        if (data != null){
            ...
            for (int i = 0; i < segment.length; i++){
                ...
                if(i == 0){
                    canvas.drawText("Good", arcCenterX - 210 - text_width, arcCenterY , textPaint);
                }

                if(i == segment.length - 1){
                    canvas.drawText("Bad", arcCenterX + 210 + 10, arcCenterY , textPaint);
                }
...
//        }
    ...
    private float getTotal(){
        ...
        for(int i = 0; i < this.data.size(); i++){
            ...
            total += Float.parseFloat(this.data.get(i).getMaxscore());
        }
        return total;
    }
    private float getScoretot(){
        ...
        for(int i = 0; i < this.data.size(); i++){
            ...
            total += Float.parseFloat(this.data.get(i).getScore());
        }
        return total;
    }
